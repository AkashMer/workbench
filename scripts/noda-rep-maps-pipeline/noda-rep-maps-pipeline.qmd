...
Only data from Block 1 will be used for further analysis since behavioral state should be standardized across trials[@Noda_2024-03-22]. Block 2 data will be explored in a future analysis.
...
#| fig-cap: Population Response Space for Block 1 of Session 755434585 (Mouse ID - 730760270)
