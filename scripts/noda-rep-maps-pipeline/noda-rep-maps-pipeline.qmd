...
- **VISpm and VISam** *(High reliability)*:
    ...
    - VISpm has fewer striped pattern when compared with VISam.
...
The findings above suggest the presence of hierarchical representational maps which evolve along the neuronal circuit.  
